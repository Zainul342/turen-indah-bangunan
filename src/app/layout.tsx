...
export default function RootLayout({
    ...
    return (
        <html lang="id">
            <body className={`${inter.variable} ${outfit.variable} ${spaceGrotesk.variable} ${playfair.variable} font-sans`}>
                <AuthProvider>
                    <div className="flex min-h-screen flex-col bg-nix-offwhite">
                        <Header />
